...
AddHotelDataModel.init({
    ...
    hotel_star: { type: sequelize_1.DataTypes.INTEGER, allowNull: false },
    ...
    hotel_status: { type: sequelize_1.DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    hotel_city: { type: sequelize_1.DataTypes.STRING },
    cur_label: { type: sequelize_1.DataTypes.STRING },
    supplier_name: { type: sequelize_1.DataTypes.STRING },
    supplier_acc_id: { type: sequelize_1.DataTypes.STRING },
    currency: { type: sequelize_1.DataTypes.INTEGER },
    roe: { type: sequelize_1.DataTypes.INTEGER },
}, {
    timestamps: false,
